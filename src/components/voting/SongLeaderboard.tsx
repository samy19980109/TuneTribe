...
interface SongLeaderboardProps {
  ...
  onPlay: (nomination: SongNomination) => void
  currentTrackId: string | null
  isPlaying: boolean
}

export default function SongLeaderboard({ nominations, onPlay, currentTrackId, isPlaying }: SongLeaderboardProps) {
  ...
  return (
    <div className="space-y-2">
      {sorted.map((nom, index) => {
        const isThisPlaying = isPlaying && currentTrackId === nom.spotify_track_id
